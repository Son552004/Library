<?php
	...
	if(isset($_POST['update'])) {
		...
		if($update_query_run) {
			...
			echo "<script type=\"text/javascript\">alert('Cập nhật hồ sơ thành công!'); window.location.href = 'admin_dashboard.php';</script>";
			exit();
		} else {
			$error_message = "Có lỗi xảy ra khi cập nhật thông tin: " . mysqli_error($connection);
