...
<body>
	...
	<div class="hello">
		...
		<h5 class="text-center text-white"> <b><i>Xem và quản lý thông tin cá nhân của bạn</i></b></h5>
	</div>
	...
	<div class="profile-container">
		...
		<div class="profile-info">
			...
			<p><strong>ID:</strong> <?php echo isset($_SESSION['id']) ? $_SESSION['id'] : 'N/A'; ?></p>
			<p><strong>Ngày tạo:</strong> <?php echo isset($_SESSION['creation_date']) ? $_SESSION['creation_date'] : 'N/A'; ?></p>
